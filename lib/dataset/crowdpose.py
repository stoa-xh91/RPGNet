...
if __name__ == '__main__':
    coco_ds = json.load(
        open('/home/wangxuanhan/research/project/deep-high-resolution-net/data/coco/annotations/person_keypoints_val2017.json'))
    ds = json.load(open('/home/wangxuanhan/research/project/deep-high-resolution-net/data/crowd_pose/json/crowdpose_test.json'))
